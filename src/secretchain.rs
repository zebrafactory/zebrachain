...
impl SecretChainIter {
    fn new(file: File, secret: Secret, count: u128, first_block_hash: Hash) -> Self {
    ...
    */
    ...
    fn test_store_derive_secret() {
        ...
        assert_eq!(
            sec.as_bytes(),
            &[
                224, 169, 191, 156, 111, 95, 23, 211, 203, 171, 45, 86, 76, 142, 220, 227, 6, 212,
                123, 252, 235, 204, 66, 160, 207, 153, 242, 154, 184, 42, 7, 21
            ],
        );
