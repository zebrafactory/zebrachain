...
fn derive_block_sub_secrets(
    ...
    let block_key = chain_secret.derive_sub_secret_256(CONTEXT_BLOCK_KEY, block_index);
    let block_nonce = chain_secret.derive_sub_secret_192(CONTEXT_BLOCK_NONCE, block_index);
